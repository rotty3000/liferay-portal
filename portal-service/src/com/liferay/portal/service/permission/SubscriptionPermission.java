...
public interface SubscriptionPermission {
	 ...
	 * @param  subscriptionClassName the class name of the subscribable entity
	 * @param  subscriptionClassPK the primary key of the subscribable entity
	 * @param  inferredClassName the class name of the inferred entity
	 *         (optionally <code>null</code> if the the subscription entity is
	 *         the inferred entity).
	 * @param  inferredClassPK the primary key of the inferred entity.
	 * @throws PortalException if the user did not have permission to view the
	 *         inferred entity or receive notifications about the subscription
	 ...
	 * subscription entity and receive notifications about the inferred entity.
	 *
	 * <p>
	 * If the subscription entity is a container and if an inferred entity
	 ...
	 * of the notification. A failed view check on the inferred entity short
	 * circuits further permission checks and prevents notifications from being
	 * sent. Checking the view permission on the inferred entity is useful for
	 * enforcing permissions for private subtrees within larger container
	 * entities to which the user is subscription.
	 * </p>
	 *
	 * <p>
	 * If the subscription entity and the inferred entity are the same, then no
	 * inferred entity needs to be specified. Without any inferred entity
	 * specified only the subscription check on the subscription entity is
	 * performed.
	 * </p>
	 *
	 * @param  permissionChecker the permission checker
	 ...
	 *         subscription entity and receive notifications about the inferred
