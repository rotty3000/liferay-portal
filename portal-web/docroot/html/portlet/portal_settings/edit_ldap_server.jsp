	...
	Liferay.provide(
		...
		function(type) {
			...
			if (type == 'ldapConnection') {
				...
				url = '<portlet:renderURL windowState="<%= LiferayWindowState.EXCLUSIVE.toString() %>"><portlet:param name="mvcRenderCommandName" value="/portal_settings/test_ldap_group" /></portlet:renderURL>';
