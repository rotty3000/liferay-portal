	...
	Liferay.provide(
		...
		function(type) {
			...
			if (type == 'ldapConnection') {
				...
				url = '<portlet:renderURL windowState="<%= LiferayWindowState.EXCLUSIVE.toString() %>"><portlet:param name="mvcPath" value="/html/portlet/portal_settings/test_ldap_groups.jsp" /></portlet:renderURL>';
