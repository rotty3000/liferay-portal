...
<aui:script>
	Liferay.provide(
		...
		function() {
			...
			var url = '<portlet:renderURL windowState="<%= LiferayWindowState.EXCLUSIVE.toString() %>"><portlet:param name="mvcPath" value="/html/portlet/portal_settings/test_opensso_configuration.jsp" /></portlet:renderURL>';
