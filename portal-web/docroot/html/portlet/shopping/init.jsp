...
page import="com.liferay.portlet.shopping.DuplicateFieldNameException" %><%@
...
ShoppingSettings shoppingSettings = ShoppingSettings.getInstance(themeDisplay.getSiteGroupId());
