...
public class MFUtil {
	...
	private String _getState(long bundleId) throws PortalException {
		...
		if (bundle == null) {
			throw new MFException("No bundle with ID " + bundleId);
		}
	...
	private void _registerService(
		...
		properties.put(MFConstants.BEAN_ID, beanName);
	...
	private void _registerServletContext(ServletContext servletContext) {
		...
		properties.put(MFConstants.BEAN_ID, ServletContext.class.getName());
		properties.put(MFConstants.ORIGINAL_BEAN, Boolean.TRUE);
		properties.put(MFConstants.SERVICE_VENDOR, ReleaseInfo.getVendor());
	...
	private static Log _log = LogFactoryUtil.getLog(MFUtil.class);
