...
public class PropsValues {
	...
	public static final boolean PERMISSIONS_ROLE_HAS_VIEW_PERMISSION_ON_SELF_BY_DEFAULT = GetterUtil.getBoolean(PropsUtil.get(PropsKeys.PERMISSIONS_ROLE_HAS_VIEW_PERMISSION_ON_SELF_BY_DEFAULT));
