...
public class SecureXMLBuilderImplTest extends PowerMockito {
	...
	public void setUp() throws Exception {
		_secureXMLBuilder = new SecureXMLBuilderImpl();
	}
		...
		XMLSecurityTest documentBuilderTestCase = new XMLSecurityTest() {
			...
			public void run(String xml) throws Exception {
				DocumentBuilderFactory documentBuilderFactory =
					_secureXMLBuilder.newDocumentBuilderFactory();
		...
		XMLSecurityTest xmlInputFactoryTest = new XMLSecurityTest() {
			...
			public void run(String xml) throws Exception {
				XMLEventReader  xmlEventReader =
					_secureXMLBuilder.newXMLInputFactory().createXMLEventReader(
	...
	public void testNewXMLReader() throws Throwable {
		XMLSecurityTest xmlReaderTest = new XMLSecurityTest() {
			@Override
			public void run(String xml) throws Exception {
				XMLReader xmlReader = _secureXMLBuilder.newXMLReader();
	...
	protected static String readDependency(String name) throws IOException {
		return StringUtil.read(
			SecureXMLBuilderImplTest.class.getResourceAsStream(
				"dependencies/" + name));
	}
	...
	private SecureXMLBuilderImpl _secureXMLBuilder;

	private static abstract class XMLSecurityTest {
