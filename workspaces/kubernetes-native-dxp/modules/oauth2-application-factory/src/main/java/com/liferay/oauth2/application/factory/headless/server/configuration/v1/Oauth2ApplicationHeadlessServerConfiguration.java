...
package com.liferay.oauth2.application.factory.headless.server.configuration.v1;
...
@Meta.OCD(
	factory = true,
	id = "com.liferay.oauth2.application.factory.headless.server.configuration.v1.Oauth2ApplicationHeadlessServerConfiguration",
	localization = "content/Language",
	name = "oauth2-application-headless-server-configuration-name"
)
public interface Oauth2ApplicationHeadlessServerConfiguration {
