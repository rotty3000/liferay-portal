...
@Component(
	property = {
		...
		"javax.portlet.display-name=View Layouts",
		"javax.portlet.expiration-cache=0",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/view_layouts.jsp",
		"javax.portlet.name=" + LayoutAdminPortletKeys.VIEW_LAYOUTS,
...
public class ViewLayoutsPortlet extends LayoutAdminPortlet {
