 ...
 */
public class SiteInitializerCETImpl
	extends BaseCETImpl implements SiteInitializerCET {

	public SiteInitializerCETImpl(ClientExtensionEntry clientExtensionEntry) {
		super(clientExtensionEntry);
	}

	public SiteInitializerCETImpl(PortletRequest portletRequest) {
		this(
			StringPool.BLANK,
	...
	private static final Set<String> _urlCETPropertyNames =
		getURLCETPropertyNames(SiteInitializerCET.class);
