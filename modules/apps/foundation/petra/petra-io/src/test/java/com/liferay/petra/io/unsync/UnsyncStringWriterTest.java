...
public class UnsyncStringWriterTest {
	...
	unsyncStringWriter.stringBuilder.charAt(0));
	//
	...
	unsyncStringWriter.stringBuilder.charAt(1));
	//
	//		// StringBundler
	//
	...
	//		Assert.assertEquals("a",
	unsyncStringWriter.stringBundler.stringAt(0));
	//
	//		unsyncStringWriter.append('b');
	//
	...
	unsyncStringWriter.stringBundler.stringAt(0));
	//		Assert.assertEquals("b",
	unsyncStringWriter.stringBundler.stringAt(1));
	//	}
	//
	//	@Test
	...
	unsyncStringWriter.stringBuilder.charAt(2));
	//		Assert.assertEquals('d',
	unsyncStringWriter.stringBuilder.charAt(3));
	//
	//		// StringBundler
	//
	//		unsyncStringWriter = new UnsyncStringWriter();
	...
	unsyncStringWriter.stringBuilder.capacity());
	//		Assert.assertNull(unsyncStringWriter.stringBundler);
	//
	...
	//		Assert.assertNotNull(unsyncStringWriter.stringBundler);
	//		Assert.assertEquals(16,
	unsyncStringWriter.stringBundler.capacity());
	//
