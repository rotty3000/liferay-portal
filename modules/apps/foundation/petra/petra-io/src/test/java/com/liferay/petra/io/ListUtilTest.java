...
public class ListUtilTest {
	...
	public void testToStringIntegerList() throws Exception {
		...
		Assert.assertEquals(
			"111,222,333", ListUtil.toString(list, StringPool.COMMA));
	}
	...
	public void testToStringLongList() throws Exception {
		...
		Assert.assertEquals(
			"111, 222, 333",
			ListUtil.toString(list, StringPool.COMMA_AND_SPACE));
	}
	...
	public void testToStringStringList() throws Exception {
		...
		Assert.assertEquals(
			"aaa.bbb.ccc", ListUtil.toString(list, StringPool.PERIOD));
	}
