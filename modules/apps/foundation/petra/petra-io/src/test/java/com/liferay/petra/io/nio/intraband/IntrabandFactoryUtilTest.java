...
public class IntrabandFactoryUtilTest {
	...
	public void testCreateIntrabandClassNotFound() throws IOException {
		System.setProperty(IntrabandFactoryUtil.INTRABAND_IMPL, "NoSuchClass");
		...
		try {
			...
			System.clearProperty(IntrabandFactoryUtil.INTRABAND_IMPL);
		}
	}
	...
	public void testCreateIntrabandCustomizedImpl() throws Exception {
		System.setProperty(
			IntrabandFactoryUtil.INTRABAND_IMPL,
			SelectorIntraband.class.getName());
	...
	public void testCreateIntrabandDefaultToFIFO() throws Exception {
		System.setProperty(
			WelderFactoryUtil.INTRABAND_WELDER_IMPL,
		...
		try {
			...
			System.clearProperty(WelderFactoryUtil.INTRABAND_WELDER_IMPL);
		}
	}
