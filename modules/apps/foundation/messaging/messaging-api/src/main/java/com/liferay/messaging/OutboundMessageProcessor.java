...
/**
 * <p>
 * Interface for processing out-bound messages before and after being sent. Each
 * execution creates a new processor instance, so they are thread safe. Both
 * before and after stages are guaranteed to be executed so it's possible to
 * implement "around" behaviour.
 * </p>
 *
 * @author Raymond Augé
 */
