...
import com.liferay.web.extender.definition.FilterDefinition;
import com.liferay.web.extender.definition.ListenerDefinition;
import com.liferay.web.extender.definition.ServletDefinition;
import com.liferay.web.extender.web.WebXML;
import com.liferay.web.extender.web.WebXMLLoader;
...
public class HttpServiceTracker
	...
	public HttpService addingService(ServiceReference<HttpService> reference) {
		HttpService httpService = _bundleContext.getService(reference);

		HttpContext httpContext = httpService.createDefaultHttpContext();

		readConfiguration(_bundleContext.getBundle());
		...
		initMimeResourceMappings(
			httpService, _bundleContext.getBundle(), httpContext, "/");
		...
		while (entryPaths.hasMoreElements()) {
			...
			try {
				...
				httpService.registerResources(
					entryPath, StringPool.BLANK, httpContext);
