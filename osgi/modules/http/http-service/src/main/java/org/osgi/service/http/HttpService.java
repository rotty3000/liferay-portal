 ...
 * 
 * @ThreadSafe
 * @author $Id: b7c3f813ae788f7dac4d86c297b63f902b4a08b6 $
 * @see HttpContext
 * @deprecated As of 1.3. Use the whiteboard pattern to register servlets and
 *             {@link ResourceServlet} servlets. Register a servlet as a service
 *             of type {@code javax.servlet.Servlet} adding at least the
 *             {@link HttpConstants#HTTP_WHITEBOARD_SERVLET_PATTERN} service
 *             registration property. Register a {@link ResourceServlet} servlet
 *             as a service of type {@code javax.servlet.Servlet} adding at
 *             least the {@link HttpConstants#HTTP_WHITEBOARD_SERVLET_PATTERN}
 *             and {@link HttpConstants#HTTP_WHITEBOARD_RESOURCE_PREFIX} service
