...
public class UserUtil {
	 ...
	 * @return the matching users
	 */
	public static List<User> findByC_DU(long companyId, boolean defaultUser) {
	 ...
	 * @return the range of matching users
	 */
	public static List<User> findByC_DU(
		long companyId, boolean defaultUser, int start, int end) {

		return getPersistence().findByC_DU(companyId, defaultUser, start, end);
	}
	...
	public static List<User> findByC_DU(
		...
		return getPersistence().findByC_DU(
	 ...
	 * @throws NoSuchUserException if a matching user could not be found
	 */
	public static User findByC_DU_First(
			long companyId, boolean defaultUser,
			OrderByComparator<User> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchUserException {

		return getPersistence().findByC_DU_First(
	 ...
	 * @return the first matching user, or <code>null</code> if a matching user could not be found
	 */
	public static User fetchByC_DU_First(
		long companyId, boolean defaultUser,
		OrderByComparator<User> orderByComparator) {

		return getPersistence().fetchByC_DU_First(
			companyId, defaultUser, orderByComparator);
	}
	 ...
	 * @throws NoSuchUserException if a matching user could not be found
	 */
	public static User findByC_DU_Last(
			long companyId, boolean defaultUser,
			OrderByComparator<User> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchUserException {

		return getPersistence().findByC_DU_Last(
			companyId, defaultUser, orderByComparator);
	}
	 ...
	 * @return the last matching user, or <code>null</code> if a matching user could not be found
	 */
	public static User fetchByC_DU_Last(
		long companyId, boolean defaultUser,
		OrderByComparator<User> orderByComparator) {

		return getPersistence().fetchByC_DU_Last(
			companyId, defaultUser, orderByComparator);
	}
	 ...
	 * @throws NoSuchUserException if a user with the primary key could not be found
	 */
	public static User[] findByC_DU_PrevAndNext(
			long userId, long companyId, boolean defaultUser,
			OrderByComparator<User> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchUserException {

		return getPersistence().findByC_DU_PrevAndNext(
			userId, companyId, defaultUser, orderByComparator);
	}
	 ...
	 * @throws NoSuchUserException if a matching user could not be found
	 */
	public static User findByC_DU_T(
			long companyId, boolean defaultUser, int type)
		throws com.liferay.portal.kernel.exception.NoSuchUserException {

		return getPersistence().findByC_DU_T(companyId, defaultUser, type);
	}
	 ...
	 * @return the matching user, or <code>null</code> if a matching user could not be found
	 */
	public static User fetchByC_DU_T(
		long companyId, boolean defaultUser, int type) {

		return getPersistence().fetchByC_DU_T(companyId, defaultUser, type);
	}
	...
	public static User fetchByC_DU_T(
		...
		return getPersistence().fetchByC_DU_T(
			companyId, defaultUser, type, useFinderCache);
	}
	 ...
	 * @return the user that was removed
	 */
	public static User removeByC_DU_T(
			long companyId, boolean defaultUser, int type)
		throws com.liferay.portal.kernel.exception.NoSuchUserException {

		return getPersistence().removeByC_DU_T(companyId, defaultUser, type);
	}
	 ...
	 * @return the number of matching users
	 */
	public static int countByC_DU_T(
		long companyId, boolean defaultUser, int type) {

		return getPersistence().countByC_DU_T(companyId, defaultUser, type);
	}
