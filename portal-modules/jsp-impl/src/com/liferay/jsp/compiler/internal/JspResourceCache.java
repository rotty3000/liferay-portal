...
public class JspResourceCache implements BundleListener {
	...
	public void bundleChanged(BundleEvent event) {
		...
		_bundleResourceMap.remove(event.getBundle());
	}

	public Collection<String> getResources(
		BundleWiring bundleWiring, String path) {

		Map<String, Collection<String>> resourceMap = _bundleResourceMap.get(
	...
	private Map<Bundle, Map<String,Collection<String>>> _bundleResourceMap =
