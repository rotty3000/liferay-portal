...
public class Activator
	...
	public ServletContext addingService(
		...
		servletProperties.put(
			MFConstants.BEAN_ID, OSGiServlet.class.getName());
		servletProperties.put(
			MFConstants.ORIGINAL_BEAN, Boolean.TRUE.toString());
		servletProperties.put(
			MFConstants.SERVICE_VENDOR, ReleaseInfo.getVendor());

		ServletConfig servletConfig = new BundleServletConfig(
			servletContext, OSGiServlet.NAME, servletProperties,
		...
		try {
			...
			StrutsActionRegistryUtil.register(
				Constants.OSGI_MAPPING, _osgiServlet);
	...
	public void removedService(
		...
		StrutsActionRegistryUtil.unregister(Constants.OSGI_MAPPING);
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		sb.append("(&(");
		sb.append(MFConstants.BEAN_ID);
		sb.append("=");
		sb.append(ServletContext.class.getName());
		sb.append(")(");
		sb.append(MFConstants.ORIGINAL_BEAN);
		sb.append("=*))");
