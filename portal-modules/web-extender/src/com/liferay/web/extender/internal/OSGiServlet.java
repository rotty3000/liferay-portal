...
import com.liferay.web.extender.servlet.ExtendedHttpService;
...
public class OSGiServlet extends PortletServlet implements StrutsAction {
	...
	public static final String NAME = "OSGi Servlet";
	...
	public void init(ServletConfig servletConfig) throws ServletException {
		...
		properties.put(MFConstants.BEAN_ID, HttpService.class.getName());
		properties.put(MFConstants.ORIGINAL_BEAN, Boolean.TRUE);
		properties.put(MFConstants.SERVICE_VENDOR, ReleaseInfo.getVendor());
	...
	public void service(
		...
		if (pathInfo.startsWith(Constants.OSGI_MAPPING)) {
	...
	protected void service(
		...
		try {
			...
			if (pathInfo.endsWith(Constants.INVOKER_PATH)) {
			...
			if (Validator.isNotNull(portletId) &&
				pathInfo.equals(Constants.INVOKER_PATH)) {
